...
// 块注释
const blockComment = hx.commands.registerCommand("extension.blockComment", async () => {
  ...
  activeEditor.edit(async editBuilder => {
    ...
    setTimeout(async () => {
      ...
      activeEditor.setSelection(activeEditor.selection.active + 4, activeEditor.selection.active + 4);
    }, 0)
  });
})
